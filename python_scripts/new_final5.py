...
path='/home/labwork/autocontrol/output_files/led_v_curve19/processed_data'
file='occupancy.npy'
...
plt.savefig(path + '/meas_v_curve.png')

plt.figure()

plt.errorbar(led_v_array[:, -2], array2[:, 5], yerr=sig_popt[:, 5], linestyle='None', marker='o')
...
plt.figure()
plt.errorbar(led_v_array2[:, -2], array[:, 2], linestyle='None', marker='o')
plt.xlabel('Input voltage')
plt.ylabel('Occupancy')
plt.title('Occupancy with input light level')
plt.savefig(path + '/occupancy_v_curve.png')

pe_charge=np.average(array2[:, 1])
