...
#set path1!!!!!
path1='/home/labwork/autocontrol/output_files//processed_data/occupancy.npy'
path2='/Azimuth2'
...
plt.errorbar(set_other[:, 1]*0.5, avg_pe_ratio, yerr=avg_pe_ratio_err, label='My Data')

plt.errorbar(setting*0.5, averaged_pe, yerr=averaged_pe_err, label="Kristi's Data")
plt.grid()
...
plt.errorbar(set_other[:, 1]*0.5, occupancy_ratio, yerr=occupancy_ratio_err, label='My Data')

plt.errorbar(setting*0.5, averaged_occupancy, yerr=averaged_occupancy_err, label="Kristi's Data")
plt.grid()
